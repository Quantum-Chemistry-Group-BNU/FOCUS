...
#==================================================================
molname = 'hf' #be' #h2cluster'#h2o3' #c2'
...
#
   ...
   R = 1.0
   natoms = 2 
   mol.atom = [['O',(0.0,0.0,i*R)] for i in range(natoms)]
   mol.basis = 'sto-3g'
...
# Dump integrals
#==================================================================
from zmpo_dmrg.source.itools import ipyscf_1cSO
iface = ipyscf_1cSO.iface(mol,mf)
#iface.ccsd()
#iface.fci()
