...
ctns: $(LIB_DIR)/libctns.a $(BIN_DIR)/tests_ctns.x \
	...
	$(BIN_DIR)/ctns.x $(BIN_DIR)/sadmrg.x $(BIN_DIR)/mpsprop.x
else
ctns:	
endif
...
$(BIN_DIR)/mpsprop.x: $(OBJ_DIR)/mpsprop.o $(LIB_DIR)/libctns.a
	@echo "=== LINK $@"
	$(CXX) $(FLAGS) -o $@ $(OBJ_DIR)/mpsprop.o -L$(LIB_DIR) -lctns $(LFLAGS) 
