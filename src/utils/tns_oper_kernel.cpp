...
// renorm Ic*Or
qtensor2 tns::oper_kernel_right_IcOr(const qtensor3& bsite,
   ...
   auto qt2 = contract_qt3_qt3_cr(bsite,qt3,rop.msym);
   qt2.index = rop.index;
   return qt2;
}

// renorm Oc*Ir
qtensor2 tns::oper_kernel_right_OcIr(const qtensor3& bsite,
				     const qtensor3& ksite,
 				     const qtensor2& cop){
   auto qt3 = contract_qt3_qt2_c(ksite,cop); 
   auto qt2 = contract_qt3_qt3_cr(bsite,qt3,cop.msym);
   qt2.index = cop.index;
   return qt2;
}

// renorm Oc*Or
qtensor2 tns::oper_kernel_right_OcOr(const qtensor3& bsite,
				     const qtensor3& ksite,
				     const qtensor2& cop,
				     const qtensor2& rop){
   auto qt3 = contract_qt3_qt2_r(ksite,rop);
   ...
   auto qt2 = contract_qt3_qt3_cr(bsite,qt3,cop.msym+rop.msym);
   qt2.index = cop.index;
...
qtensor2 tns::oper_kernel_right_OrOc(const qtensor3& bsite,
				     const qtensor3& ksite,
				     const qtensor2& rop,
				     const qtensor2& cop){
   auto qt3 = contract_qt3_qt2_r(ksite,rop);
