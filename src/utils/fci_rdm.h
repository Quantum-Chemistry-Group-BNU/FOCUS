...
void get_rdm1_diag(const fock::onspace& space,
...
void get_rdm2_diag(const fock::onspace& space,
 	           const std::vector<double>& civec1,
	           const std::vector<double>& civec2,
	           linalg::matrix& rdm2);

void get_rdm2S(const fock::onstate& stateI,
               const fock::onstate& stateJ,
...
void get_rdm2D(const fock::onstate& stateI,
	       const fock::onstate& stateJ,
	       const double& civec1I,
	       const double& civec1J,
	       const double& civec2I,
...
void make_rdm2(const fock::onspace& space,
