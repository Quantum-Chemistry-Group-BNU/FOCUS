...
namespace ctns{
   ...
   template <typename Tm>
      struct Rmu_ptr{
         public:
            ...
            void init(const int k, const int it,
            ...
            // onedot
            void gen_Rlist(const std::string superblock,
   ...
   template <typename Tm>
      void Rmu_ptr<Tm>::init(const int k, const int it,
            const symbolic_task<Tm>& R_formulae,
            const oper_dictmap<Tm>& qops_dict,
            const rintermediates<Tm>& rinter,
            const std::map<std::string,int>& oploc){
   ...
   template <typename Tm>
      void Rmu_ptr<Tm>::gen_Rlist(const std::string superblock,
            const qinfo3<Tm>& site_info,
            Rlist<Tm>& Rlst,
            size_t& blksize,
            double& cost,
   ...
   // lr: O[bm,bm'] = psi*[br,bc,bm] sigma[br,bc,bm'] (Ol^dagger0[br,br'] Or^dagger1[bc,bc']) psi[br',bc',bm']
   template <typename Tm>
      void Rmu_ptr<Tm>::gen_Rlist2Direct(const std::string superblock,
            const qinfo3<Tm>& site_info,
            Rlist2<Tm>& Rlst2,
            size_t& blksize,
            size_t& blksize0,
