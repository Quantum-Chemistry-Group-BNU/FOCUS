      ...
      void sweep_onedot(comb<Qm,Tm>& icomb,
         ...
         if(debug && schd.ctns.verbose>0){
            ...
            std::cout << " qops(tot)=" << opertot
               ...
               << std::endl;
            get_mem_status(rank, 0, "sweep_onedot", alg_hvec>10 or alg_renorm>10);
         }
         ...
         if(debug){
            ...
            get_mem_status(rank, 0, "after onedot_localCI", alg_hvec>10 or alg_renorm>10);
         }
         ...
         if(debug){
            get_mem_status(rank, 0, "after sweep_onedot", alg_hvec>10 or alg_renorm>10);
