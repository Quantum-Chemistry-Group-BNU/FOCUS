...
void Hxblock<Tm>::kernel(const Tm* x,
   ...
   if(location[3] != -1){
      optr = const_cast<Tm*>(locations[3])+offop[3];
      int vdim = dimout[3];
      int xdim = din[3];
   ...
   if(location[2] != -1){
      optr = const_cast<Tm*>(locations[2])+offop[2];
      int mdim = dimout[2];
      int xdim = din[2];
   ...
   if(location[1] != -1){
      optr = const_cast<Tm*>(locations[1])+offop[1];
      int cdim = dimout[1];
      int xdim = din[1];
   ...
   if(location[0] != -1){
      optr = const_cast<Tm*>(locations[0])+offop[0];
      int rdim = dimout[0];
      int xdim = din[0];
