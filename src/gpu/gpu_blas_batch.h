...
inline void xgemm_batch_gpu(const char transa, const char transb, 
        ...
        const magma_int_t batch_count, const magma_int_t a_total_count, const magma_int_t b_total_count, const magma_int_t c_total_count)
{
    if(batch_count <= 0)
    {
