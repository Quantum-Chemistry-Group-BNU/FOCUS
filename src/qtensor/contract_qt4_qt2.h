   ...
   template <typename Tm>
      void contract_qt4_qt2_info_l(const qinfo4<Tm>& qt4a_info,
         ...
         for(int i=0; i<qt4_info._nnzaddr.size(); i++){
            ...
            if(bx != -1){
               size_t off4a = qt4a_info.get_offset(bx,bc,bm,bv);
               if(off4a != 0){
                  ifzero = false; 
   ...
   template <typename Tm>
      void contract_qt4_qt2_info_r(const qinfo4<Tm>& qt4a_info,
         ...
         for(int i=0; i<qt4_info._nnzaddr.size(); i++){
            ...
            if(bx != -1){
               size_t off4a = qt4a_info.get_offset(br,bx,bm,bv);
               if(off4a != 0){
                  ifzero = false;
   ...
   template <typename Tm>
      void contract_qt4_qt2_info_c1(const qinfo4<Tm>& qt4a_info,
         ...
         for(int i=0; i<qt4_info._nnzaddr.size(); i++){
            ...
            if(bx != -1){
               size_t off4a = qt4a_info.get_offset(br,bc,bx,bv);
               if(off4a != 0){
                  ifzero = false;
   ...
   template <typename Tm>
      void contract_qt4_qt2_info_c2(const qinfo4<Tm>& qt4a_info,
         ...
         for(int i=0; i<qt4_info._nnzaddr.size(); i++){
            ...
            // 	      = \sum_x qt2(x,v)*qt4a(r,c,m,x) ; iftrans=true
            int bx = iftrans? qt2_info._bc2br[bv] : qt2_info._br2bc[bv];
            if(bx != -1){
               size_t off4a = qt4a_info.get_offset(br,bc,bm,bx);
               if(off4a != 0){
                  ifzero = false;
