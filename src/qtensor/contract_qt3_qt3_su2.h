#ifndef CONTRACT_QT3_QT3_SU2_H
#define CONTRACT_QT3_QT3_SU2_H
...
namespace ctns{
   ...
   template <typename Tm>
      stensor2su2<Tm> contract_qt3_qt3(const std::string superblock,
            const stensor3su2<Tm>& qt3a, 
            const stensor3su2<Tm>& qt3b){

         // only for symmetry is zero
         assert(qt3a.info.sym.is_zero());
         assert(qt3b.info.sym.is_zero());
...
*/
   ...
   //          c--*--/ qt3b
   template <typename Tm>
      void contract_qt3_qt3_info_cr(const qinfo3su2<Tm>& qt3a_info,
            Tm* qt3a_data,	
            const qinfo3su2<Tm>& qt3b_info,
            Tm* qt3b_data,
            qinfo2su2<Tm>& qt2_info,
...
/*
   ...
   //            c|
   template <typename Tm>
      void contract_qt3_qt3_info_lr(const qinfo3su2<Tm>& qt3a_info,
            Tm* qt3a_data,	
            const qinfo3su2<Tm>& qt3b_info,
            Tm* qt3b_data,
            qinfo2su2<Tm>& qt2_info,
